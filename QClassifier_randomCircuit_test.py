...
plot_list=[]
num_data=10000
#batch_size=[30,40,50,70,100,150,200,300,400,500]
...
for batch in batch_size:
    ...
    for replica in range(num_data):
        ...
        for _ in range(batch):
            ...
            new_data=in_data.evolve(circuit_2)
            output_data=in_data.evolve(circuit_1)

            input_expectation=new_data.expectation_value(observables)
            output_expectation=output_data.expectation_value(observables)
            instance_difference=sigmoid(output_expectation)-sigmoid(input_expectation)
        ...
        global_difference=sigmoid(output_global_expect)-sigmoid(input_global_expect)
        ...
        if global_difference >0:
            ...
            if instance_difference_total>0:
                instance_positive+=1
        #print(global_difference,sigmoid(output_global_expect),sigmoid(input_global_expect))
    ...
    #print(global_list,instance_list)
