...
for i in range(len(input_list)):
    ...
    plt.plot(bs,epsilon,linewidth=2.5,color=color_list[i],linestyle=line_list[i],marker=marker_list[i],markersize=8 ,label='Random Global QNN, '+input_list[i]+' synthetic SNPs')
